...
// 2. CSRF Protection Initialization
// Generate a secure random token if it doesn't exist yet.
// This token ensures that the form submission comes from your site, not a malicious one.
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
    ...
    // CSRF Check: Verify the token matches
...
// Handle case where user might not exist (edge case)
if (!$user) {
...
$sig_stmt->bindValue(1, $user_id, SQLITE3_INTEGER);
...
<head>
    ...
    <title>My Profile - SubSignature</title>
    
    <link rel="stylesheet" href="css/style.css">
    <link rel="stylesheet" href="css/all.min.css">
    
    <style>
        /* Profile Specific Styles - Kept exactly as original */
        .profile-layout {
            display: grid;
        ...
        @media (max-width: 900px) {
            ...
            .profile-card { order: -1; } /* Stats on top on mobile */
        }
    </style>
</head>
<body>
    ...
    <aside class="sidebar">
        ...
        <?php 
        // Safe Include: Ensures the navbar file exists before including
        if (file_exists('includes/navbar.php')) {
            include 'includes/navbar.php';
        } else {
            // Fallback navigation if file is missing (Development safety)
            ...
            <div class="settings-card">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label>Role</label>
                        <input type="text" 
                               value="<?php echo htmlspecialchars(ucfirst($user['role']), ENT_QUOTES, 'UTF-8'); ?>" 
                               disabled 
                               style="background: #f3f4f6; color: var(--text-muted);">
                    </div>
            ...
            <div class="profile-card">
                ...
                <div class="stats-list">
                    ...
                    <div class="stat-row">
                        ...
                        <span class="stat-val">
                            <?php echo $user['last_login'] ? date('d.m.Y', strtotime($user['last_login'])) : 'Never'; ?>
                        </span>
                    </div>
                    <div class="stat-row">
                    ...
                    <div class="stat-row">
                        <span class="stat-key"><i class="fas fa-shield-alt"></i> Status</span>
                        <span class="stat-val" style="color: #16a34a;"><i class="fas fa-check-circle"></i> Active</span>
                    </div>
                </div>
                ...
                <div class="action-list">
                    ...
                    <a href="csv_import.php" class="action-btn">
                        <i class="fas fa-file-import"></i> Import Data
                    </a>
                    <?php if (isAdmin()): ?>
                        <a href="admin_users.php" class="action-btn" style="color: var(--primary); border-color: var(--primary);">
                            <i class="fas fa-users-cog" style="color: var(--primary);"></i> User Management
                        </a>
                    <?php endif; ?>
                </div>
            </div>
